...
//     const watchlist = JSON.parse(localStorage.getItem('watchlist') || '[]');
//     const updated = bookmarked ? watchlist.filter(id => id !== record._id) : [...watchlist, record._id];
...
//               {/* Phase 3: Score Explainer Button */}
...
// import axios from "axios";
// import API_BASE from "../config/api";
// // 🚨 REMOVED ChatbotWidget import here because it's globally rendered in App.jsx!
...
//   // Phase 3: Voice Reader & Score Explainer
//   const [isSpeaking, setIsSpeaking] = useState(false);
//   const speechRef = useRef(null);
//   const [scoreFactors, setScoreFactors] = useState([]);
//   const [factorsLoading, setFactorsLoading] = useState(false);
...
//   // Phase 3: Web Speech API Voice Reader
//   const readAloud = () => {
//     if (!window.speechSynthesis) return alert('Your browser does not support text-to-speech.');
//     if (isSpeaking) {
//       window.speechSynthesis.cancel();
